...
HD_PWD='C:/Users/sebas/Desktop/newZDUPproject/uBBezPar/sumator/sumator.runs/sumator_design_microblaze_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sumator_design_microblaze_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sumator_design_microblaze_0_0.tcl
