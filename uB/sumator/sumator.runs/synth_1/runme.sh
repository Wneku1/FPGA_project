...
HD_PWD='C:/Users/sebas/Desktop/newZDUPproject/uBBezPar/sumator/sumator.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sumator_design_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sumator_design_wrapper.tcl
