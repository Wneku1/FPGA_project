...
HD_PWD='c:/users/sebas/desktop/newzdupproject/zynqbezpar/ip_repo/edit_sum_ip_v1_0.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sum_ip_v1_0.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sum_ip_v1_0.tcl -notrace
