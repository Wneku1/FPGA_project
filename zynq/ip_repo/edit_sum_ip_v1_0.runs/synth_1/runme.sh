...
HD_PWD='c:/users/sebas/desktop/newzdupproject/zynqbezpar/ip_repo/edit_sum_ip_v1_0.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sum_ip_v1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sum_ip_v1_0.tcl
