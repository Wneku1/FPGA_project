...
HD_PWD='C:/Users/sebas/Desktop/newZDUPproject/zynqBezPar/sumator/sumator.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sum_design_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sum_design_wrapper.tcl
