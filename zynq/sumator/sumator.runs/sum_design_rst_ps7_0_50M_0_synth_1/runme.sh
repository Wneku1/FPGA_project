...
HD_PWD='C:/Users/sebas/Desktop/newZDUPproject/zynqBezPar/sumator/sumator.runs/sum_design_rst_ps7_0_50M_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sum_design_rst_ps7_0_50M_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sum_design_rst_ps7_0_50M_0.tcl
