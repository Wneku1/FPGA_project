...
HD_PWD='C:/Users/sebas/Desktop/newZDUPproject/zynqBezPar/sumator/sumator.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sum_design_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sum_design_wrapper.tcl -notrace
